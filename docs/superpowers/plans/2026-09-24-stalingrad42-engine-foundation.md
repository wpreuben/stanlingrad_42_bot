...
이후 추축군 `23`·`29`(`1515`), `14`(`2029`), `13`·`125`(`2533`), `73`(`2634`)와 소련군 `6`(`1604`)·`227`(`1309`)·`301`(`1311`)도 감소된 면 시작으로 확인했다. 현재 면별 이미지 대조는 171개 중 100개다. 추축군 `5`(`1936`)의 대응 이미지는 아직 찾지 못했다. `upload_id`가 없는 카운터는 1단계로 간주하지 않고 다른 원본을 더 확인한다.
