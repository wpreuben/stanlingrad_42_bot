...
현재 171개 중 100개(추축군 77개, 소련군 23개)의 시작 면을 개별 이미지 183개와 대조했다. 추축군 카드의 지도 배치 카운터 가운데 `5`(`1936`)만 대응 개별 이미지를 아직 찾지 못했다. 추축군 `23`·`29`(`1515`), `14`(`2029`), `13`·`125`(`2533`), `73`(`2634`)와 소련군 `6`(`1604`), `227`(`1309`), `301`(`1311`)도 감소된 면으로 시작한다. `upload_id`가 없다는 사실만으로 단일 단계 카운터라고 판정하지 않는다.
