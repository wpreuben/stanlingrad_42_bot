...
현재 171개 중 165개(추축군 77개, 소련군 88개)의 시작 면을 개별 이미지 295개와 대조했다. 아직 대응 이미지를 확정하지 못한 것은 추축군 `5`(`1936`), 소련군 `277`·`1 TD`(`1816`), `5`(`2120`), `275`(`2023`), `4`(`2425`)의 6개다. 이 중 `1 TD`는 제공된 개별 이미지에서 비슷한 `2 TD`를 보았으나 같은 카운터로 간주하지 않았다. 추축군 `23`·`29`(`1515`), `14`(`2029`), `13`·`125`(`2533`), `73`(`2634`)와 소련군 `160`(`1502`), `62`(`1305`), `6`(`1604`), `227`(`1309`), `301`(`1311`), `124`(`1512`), `13`(`1713`), `15`(`1813`), `199+278`(`1818`), `81+304`(`1819`), `22`(`2017`), `14`(`2120`), `335+347`(`3322`)는 카드에 감소된 면이 보인다. `upload_id`가 없다는 사실만으로 단일 단계 카운터라고 판정하지 않는다.
